...
#define stringPluginName "pdvst3"
...
BEGIN_FACTORY_DEF ("Steinberg Media Technologies", 
	...
	DEF_CLASS2 (INLINE_UID_FROM_FUID(procUID),
				...
				pdvst3VST3Category, // Subcategory for this Plug-in (to be changed)
				FULL_VERSION_STR,		// Plug-in version (to be changed)
				kVstVersionString,		// the VST 3 SDK version (do not changed this, use always this define)
				pdvst3Processor::createInstance)	// function pointer called when this component should be instantiated
	...
	DEF_CLASS2 (INLINE_UID_FROM_FUID (contUID),
				...
				FULL_VERSION_STR,		// Plug-in version (to be changed)
				kVstVersionString,		// the VST 3 SDK version (do not changed this, use always this define)
				pdvst3Controller::createInstance)// function pointer called when this component should be instantiated
